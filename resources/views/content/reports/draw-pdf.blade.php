    ...
    <div class="report">
        <h3>Lotto Summary Per Municipality</h3>
        <?php
        ...
        <table width="100%">
            <tr>
                <td style="vertical-align: top;" class="table-wrapper">
                        ...
                        <table width="100%" cellspacing="0" class="table-area">
                            <thead>
                                ...
                                <tr class="border-bottom">
                                    ...
                                    <th width="20%">Bet Amt</th>
                                    <th width="20%">Win Amt</th>
                                    <th width="20%">Net</th>
                                    @endforeach
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                $grossTotal = $betAmtTotal = $winAmtTotal = $netTotal = $areaTotal = 0;
                                ?>
